...
public class MathUtilities {
    ...
    public Short add(short baseValue, short difference) {
        int intVal = baseValue + difference; // get sum as Integer
        short shortVal = (short)intVal; // cast (convert) Integer to short
        return shortVal; // return the short, autoboxed to `Short`
    }
    ...
    public Short subtract(short baseValue, short difference) {
        int delta =  baseValue - difference;
        short shortDelta = (short)delta;
        return shortDelta;
    }
